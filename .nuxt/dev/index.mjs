globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/mauriciogutierrez/Vue/schooldriver/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, isEvent, createEvent, getRequestHeader, splitCookiesString, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError, getResponseStatusText } from 'file:///Users/mauriciogutierrez/Vue/schooldriver/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/mauriciogutierrez/Vue/schooldriver/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/mauriciogutierrez/Vue/schooldriver/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/mauriciogutierrez/Vue/schooldriver/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/mauriciogutierrez/Vue/schooldriver/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/mauriciogutierrez/Vue/schooldriver/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/mauriciogutierrez/Vue/schooldriver/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/mauriciogutierrez/Vue/schooldriver/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/mauriciogutierrez/Vue/schooldriver/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/mauriciogutierrez/Vue/schooldriver/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/mauriciogutierrez/Vue/schooldriver/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/mauriciogutierrez/Vue/schooldriver/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/mauriciogutierrez/Vue/schooldriver/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/mauriciogutierrez/Vue/schooldriver/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/mauriciogutierrez/Vue/schooldriver/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/mauriciogutierrez/Vue/schooldriver/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/mauriciogutierrez/Vue/schooldriver/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file:///Users/mauriciogutierrez/Vue/schooldriver/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/mauriciogutierrez/Vue/schooldriver/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/mauriciogutierrez/Vue/schooldriver/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/mauriciogutierrez/Vue/schooldriver/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mauriciogutierrez/Vue/schooldriver","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mauriciogutierrez/Vue/schooldriver/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mauriciogutierrez/Vue/schooldriver/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mauriciogutierrez/Vue/schooldriver/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/mauriciogutierrez/Vue/schooldriver/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const script = "\"use strict\";(()=>{const a=window,e=document.documentElement,m=[\"dark\",\"light\"],c=window.localStorage.getItem(\"nuxt-color-mode\")||\"system\";let n=c===\"system\"?f():c;const l=e.getAttribute(\"data-color-mode-forced\");l&&(n=l),i(n),a[\"__NUXT_COLOR_MODE__\"]={preference:c,value:n,getColorScheme:f,addColorScheme:i,removeColorScheme:d};function i(o){const t=\"dark\"+o+\"\",s=\"theme\";e.classList?e.classList.add(t):e.className+=\" \"+t,s&&e.setAttribute(\"data-\"+s,o)}function d(o){const t=\"dark\"+o+\"\",s=\"theme\";e.classList?e.classList.remove(t):e.className=e.className.replace(new RegExp(t,\"g\"),\"\"),s&&e.removeAttribute(\"data-\"+s)}function r(o){return a.matchMedia(\"(prefers-color-scheme\"+o+\")\")}function f(){if(a.matchMedia&&r(\"\").media!==\"not all\"){for(const o of m)if(r(\":\"+o).matches)return o}return\"light\"}})();\n";

const _dhFzpICBmR = (function(nitro) {
...
const _lazy_SX41t3 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_SX41t3, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_SX41t3, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[],"title":"SchoolDriver","charset":"utf-8"};
...
const getClientManifest = () => import('file:///Users/mauriciogutierrez/Vue/schooldriver/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/mauriciogutierrez/Vue/schooldriver/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
